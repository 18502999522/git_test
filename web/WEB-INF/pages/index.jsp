			...
			<ul>
				<li class="dropdown user-dropdown">
					<a href="javascript:void(0)" style="text-decoration: none; color: white;" class="dropdown-toggle" data-toggle="dropdown">
						<span class="glyphicon glyphicon-user"></span> ${LOGIN_EMPLOYEE.employeeName}(${LOGIN_EMPLOYEE.employeeNo}) <span class="caret"></span>
					</a>
			...
			<ul id="no1" class="nav nav-pills nav-stacked">
				...
				<li class="liClass">
					...
					<ul id="no2" class="nav nav-pills nav-stacked collapse">
						<li class="liClass"><a href="${pageContext.request.contextPath}/chars/activity" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 市场活动统计图表</a></li>
						<li class="liClass"><a href="${pageContext.request.contextPath}/chars/clue" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 线索统计图表</a></li>
						<li class="liClass"><a href="${pageContext.request.contextPath}/chars/deal" target="workareaFrame">&nbsp;&nbsp;&nbsp;<span class="glyphicon glyphicon-chevron-right"></span> 客户和联系人统计图表</a></li>
				...
				<li class="liClass"><a href="${pageContext.request.contextPath}/complete" target="workareaFrame"><span class="glyphicon glyphicon-arrow-right"></span>自动补全插件示例</a></li>
